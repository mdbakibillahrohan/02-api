...
const get_data = async (request) => {
    ...
    let query = `select at.oid, at.status, at.transactionNo,
        to_char(at.transactionDate, 'YYYY-MM-DD') as transactionDate,
		to_char(at.transactionDate :: DATE, 'dd-Mon-yyyy') as transactionDateEN, 
		at.amount,  at.transactionType, at.description, at.accountOid, a.name as accountName,
        a.accountNumber from ${ TABLE.ACCOUNT_TRANSACTION } at, ${ TABLE.ACCOUNT } as a 
