...
const save_controller = {
    method: "POST",
    path: API.CONTEXT + API.TICKET_DEPARTURE_CARD_SAVE_PATH,
    options: {
        auth: {
            mode: "required",
            strategy: "jwt",
...
const save_data = async (userInfo, oid, request) => {
    let cols = ["oid", "passengerName", "passportNumber", "flightNumber", 
    "visaNumber", "visaType", "createdBy", "createdOn", "companyOid"];
