...
module.exports = {
    ...
    API: {
        ...
        AUTHENTICATION_USER_AUTHENTICATE_USER_PATH: RESOURCES.AUTHENTICATION_USER_RESOURCE + "authenticate-user",
        AUTHENTICATION_USER_LOGOUT_PATH: RESOURCES.AUTHENTICATION_USER_RESOURCE + "logout",

        AUTHENTICATION_USER_GET_LIST_PATH: RESOURCES.AUTHENTICATION_USER_RESOURCE + "get-list",
        AUTHENTICATION_USER_GET_COMPANY_INFO_PATH: RESOURCES.AUTHENTICATION_USER_RESOURCE + "get-company-info",
        AUTHENTICATION_USER_GET_USER_INFO_PATH: RESOURCES.AUTHENTICATION_USER_RESOURCE + "get-user-info",
        AUTHENTICATION_USER_GET_USER_INFO_BY_OID_PATH: RESOURCES.AUTHENTICATION_USER_RESOURCE + "get-user-info-by-oid",
        AUTHENTICATION_USER_SAVE_SIGNUP_PATH: RESOURCES.AUTHENTICATION_USER_RESOURCE + "save-signup",
        AUTHENTICATION_USER_SAVE_UPDATE_PATH: RESOURCES.AUTHENTICATION_USER_RESOURCE + "save-update",
        AUTHENTICATION_USER_RESET_PASSWORD_PATH: RESOURCES.AUTHENTICATION_USER_RESOURCE + "reset-password",
        ...
        MASTER_PAYMENT_SAVE_PATH: RESOURCES.MASTER_PAYMENT_RESOURCE + "save",
        MASTER_PAYMENT_UPDATE_PATH: RESOURCES.MASTER_PAYMENT_RESOURCE + "update",
